...
>(({ className, ...props }, ref) => (
  ...
  >
    ...
    >
      ...
      <X className="absolute top-1/2 left-1/2 h-3 w-3 -translate-x-1/2 -translate-y-1/2 text-muted-foreground opacity-100 transition-opacity duration-200 group-data-[state=checked]:opacity-0" />
    </SwitchPrimitives.Thumb>
  </SwitchPrimitives.Root>
))

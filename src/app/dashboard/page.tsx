...
const FormattedAmount = ({
    ...
    return (
        <div className={cn('flex items-baseline tabular-nums gap-x-1 whitespace-nowrap', className)} dir="ltr">
                    ...
                    {Object.entries(successful).map(([type, s]: [string, any]) => (
                        <div key={type} className="flex justify-between items-center text-xs md:text-sm gap-2">
                            ...
                            <div className="flex items-center gap-2 md:gap-3 min-w-0">
                                ...
                                <FormattedAmount amount={s.amount} currency="ج.م" integerClass="font-bold text-xs md:text-sm" currencyClass="text-[9px] md:text-[10px]" />
                            </div>
                        </div>
                    ))}
                </div>
            </div>
            <div className="p-4 md:p-6 bg-white rounded-2xl md:rounded-[2rem] border border-slate-100 shadow-sm text-yellow-600 overflow-hidden">
                <h4 className="text-[10px] md:text-xs font-black uppercase text-inherit tracking-widest mb-3 md:mb-4 flex items-center gap-2">
            ...
            <Card className="floating-card flex flex-col p-1 md:p-2 relative">
                ...
                <CardContent className="space-y-4 md:space-y-6 flex-grow flex flex-col justify-center py-4 md:py-6 px-4 md:px-6 overflow-hidden">
                    <div className="space-y-2 md:space-y-3">
                        ...
                        <div className="flex justify-between items-center gap-2"><span className="text-slate-500 font-bold text-xs md:text-sm shrink-0">المبلغ الليبي</span><FormattedAmount amount={stats.dailyTradeStats.lydAmount} currency="د.ل" integerClass="font-bold text-sm md:text-base" currencyClass="text-[9px] md:text-[10px]" /></div>
                        <div className="flex justify-between items-center gap-2"><span className="text-slate-500 font-bold text-xs md:text-sm shrink-0">المبلغ المصري</span><FormattedAmount amount={stats.dailyTradeStats.egpAmount} currency="ج.م" integerClass="font-bold text-sm md:text-base" currencyClass="text-[9px] md:text-[10px]" /></div>
                        <div className="flex justify-between items-center gap-2"><span className="text-slate-500 font-bold text-xs md:text-sm shrink-0">حصالة الفكة</span><FormattedAmount amount={stats.dailyTradeStats.fakkaAmount} currency="ج.م" integerClass="font-bold text-sm md:text-base text-orange-600" currencyClass="text-[9px] md:text-[10px]" /></div>
                    </div>
                    ...
                    <div className="space-y-2 md:space-y-3">
                        ...
                        <div className="flex justify-between items-center gap-2"><span className="text-slate-500 font-bold text-xs md:text-sm shrink-0">المبلغ الليبي</span><FormattedAmount amount={stats.monthlyTradeStats.lydAmount} currency="د.ل" integerClass="font-bold text-sm md:text-base" currencyClass="text-[9px] md:text-[10px]" /></div>
                        <div className="flex justify-between items-center gap-2"><span className="text-slate-500 font-bold text-xs md:text-sm shrink-0">المبلغ المصري</span><FormattedAmount amount={stats.monthlyTradeStats.egpAmount} currency="ج.م" integerClass="font-bold text-sm md:text-base" currencyClass="text-[9px] md:text-[10px]" /></div>
                        <div className="flex justify-between items-center gap-2"><span className="text-slate-500 font-bold text-xs md:text-sm shrink-0">حصالة الفكة</span><FormattedAmount amount={stats.monthlyTradeStats.fakkaAmount} currency="ج.م" integerClass="font-bold text-sm md:text-base text-orange-600" currencyClass="text-[9px] md:text-[10px]" /></div>
                    </div>
                </CardContent>
            </Card>
            ...
            <Card className="floating-card flex flex-col p-1 md:p-2 overflow-hidden">
                ...
                <CardContent className="space-y-4 md:space-y-6 flex-grow flex flex-col justify-center py-4 md:py-6 px-4 md:px-6 overflow-hidden">
                    <div className="space-y-2 md:space-y-3">
                        ...
                        <div className="flex justify-between items-center gap-2"><span className="text-slate-500 font-bold text-xs md:text-sm shrink-0">قيمة المبيعات</span><FormattedAmount amount={stats.dailyCardStats.value} currency="د.ل" integerClass="font-bold text-sm md:text-base text-sky-600" currencyClass="text-[9px] md:text-[10px]" /></div>
                    </div>
                    <Separator className="bg-slate-50" />
                    <div className="space-y-2 md:space-y-3">
                        <h4 className="mb-2"><InlineMonthSelector /></h4>
                        ...
                        {Object.entries(stats.monthlyRevenueByType).map(([type, s]: [string, any]) => (
                            <div key={type} className="flex justify-between items-center text-xs md:text-sm gap-2">
                                ...
                                <div className="flex items-center gap-2 md:gap-3 min-w-0">
                                    ...
                                    <FormattedAmount amount={s.revenue} currency="ج.م" integerClass="font-bold text-[#1A4B84] text-xs md:text-sm" currencyClass="text-[9px] md:text-[10px]" />
                                </div>
                            </div>
                        ))}
                    </div>
                        ...
                        <TableBody>
                            {stats.supervisorSummary.map(s => (
                                <TableRow key={s.id} className="hover:bg-[#E3F2FD]/30 transition-colors border-b border-slate-50/50 last:border-0">
                                    ...
                                    <TableCell className="text-center overflow-hidden"><FormattedAmount amount={s.dailyTotal} currency="ج.م" integerClass="font-bold text-slate-600 text-xs md:text-sm" currencyClass="text-[8px] md:text-[10px]" /></TableCell>
                                    <TableCell className="text-center overflow-hidden"><FormattedAmount amount={s.monthlyTotal} currency="ج.م" integerClass="font-bold text-[#1A4B84] text-xs md:text-sm" currencyClass="text-[8px] md:text-[10px]" /></TableCell>
                                    <TableCell className="text-center overflow-hidden"><FormattedAmount amount={s.monthlyFees} currency="ج.م" integerClass="font-bold text-indigo-600 text-xs md:text-sm" currencyClass="text-[8px] md:text-[10px]" /></TableCell>

      ...
      <div className="flex flex-col gap-2">
        <div className="flex items-center gap-4">
          <div className="p-3 bg-cyan-100 dark:bg-cyan-900/50 rounded-2xl shadow-sm">
            <ReceiptText className="h-7 w-7 text-[#1B69FF] dark:text-cyan-400" />
          </div>
          <div>
            <h1 className="text-2xl md:text-3xl font-black text-[#001F3D]">مراجعة الحوالات المصرية المعلقة</h1>
